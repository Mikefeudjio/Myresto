<x-admin-layout>
    ...
    <div class="py-12">
        ...
        <div class="flex justify-end m-2 p-2">
            <a href="{{ route('admin.Reservation.index')}}" class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">index table</a>
        </div>
        <div class="m-2 p-2">
            ...
            <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                <form method="POST" action="{{route('admin.Reservation.store')}}" >
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-1">
                            <input type="text" id="firsh_name" name="first_name"
                    ...
                    <div class="sm:col-span-6">
                        <label for="rest_date" class="block text-sm font-medium text-gray-700">Reservation date </label>
                        <div class="mt-1">
                            <input type="datetime-local" id="rest_dete" name="rest_date"
                                class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5 @error('name') border-red-400 @enderror" />
